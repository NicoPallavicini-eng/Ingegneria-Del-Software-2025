...
public class UserShipGrid extends Pane {
    ...
    private static final int RESERVED_RIGHT_BORDER = TOT_WIDTH - RESERVED_LEFT_BORDER - (TILE_SIZE * 2); // TODO fix (feels like too wide)
    ...
    private final TileView[] handCell = new TileView[1];
