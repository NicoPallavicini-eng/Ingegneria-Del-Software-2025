...
//        assertEquals(false,ship.checkFloorPlanConnection());
        ...
        CabinTile cabin3 = new CabinTile(ConnectorType.DOUBLE,ConnectorType.SINGLE,ConnectorType.SINGLE,ConnectorType.DOUBLE,CabinInhabitants.NONE,false,Color.NONE,1,0);
        CannonTile cannon3 = new CannonTile(ConnectorType.CANNON_SINGLE,ConnectorType.SINGLE,ConnectorType.NONE,ConnectorType.NONE,true,false);
        CannonTile cannon4 = new CannonTile(ConnectorType.CANNON_DOUBLE,ConnectorType.NONE,ConnectorType.NONE,ConnectorType.UNIVERSAL,true,false);
    }
    //@Test
...
//        assertEquals(adiacentTiles,ship.checkFloorplanConnection());
    ...
    void getExposedConnectors() {
        ...
        assertEquals(1,ship.getExposedConnectors());
    }
